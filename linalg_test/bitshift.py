...
def create_custom_model_bitwise_shift(left_shift : bool = True, model_file: str = MODEL_FILE):
...
def bitwise_shift_test():  
	...
	with tempfile.TemporaryDirectory() as tmpdirname:
		...
		model_lsh = create_custom_model_bitwise_shift(left_shift=True, model_file=lft_path)
		model_rsh = create_custom_model_bitwise_shift(left_shift=False, model_file=rsh_path)
		...
		lsh_torch = run_bitwise_shift_pytorch(model_lsh,torch.from_numpy(a), torch.from_numpy(b)).numpy()
		print(lsh_torch)
		...
		rsh_torch = run_bitwise_shift_pytorch(model_rsh, torch.from_numpy(a), torch.from_numpy(b)).numpy()
		print(rsh_torch)
